package BVA::KALE::DATA::WHERE::Parser; sub new { my $self = bless( {
                 'localvars' => '',
                 'startcode' => '',
                 'namespace' => 'Parse::RecDescent::_Runtime::BVA::KALE::DATA::WHERE::Parser',
                 'rules' => {
                              'word' => bless( {
                                                 'impcount' => 0,
                                                 'calls' => [],
...
package BVA::KALE::DATA::WHERE::Parser;
{ my $ERRORS;


package Parse::RecDescent::_Runtime::BVA::KALE::DATA::WHERE::Parser;
use strict;
use vars qw($skip $AUTOLOAD  );
@Parse::RecDescent::_Runtime::BVA::KALE::DATA::WHERE::Parser::ISA = ();
$skip = '\s*';
...
local $SIG{__WARN__} = sub {0};
# PRETEND TO BE IN Parse::RecDescent::_Runtime NAMESPACE
*Parse::RecDescent::_Runtime::BVA::KALE::DATA::WHERE::Parser::AUTOLOAD   = sub
{
    no strict 'refs';

    ${"AUTOLOAD"} =~ s/^Parse::RecDescent::_Runtime::BVA::KALE::DATA::WHERE::Parser/Parse::RecDescent::_Runtime/;
    goto &{${"AUTOLOAD"}};
}
}

push @Parse::RecDescent::_Runtime::BVA::KALE::DATA::WHERE::Parser::ISA, 'Parse::RecDescent::_Runtime';
# ARGS ARE: ($parser, $text; $repeating, $_noactions, \@args, $_itempos)
sub Parse::RecDescent::_Runtime::BVA::KALE::DATA::WHERE::Parser::word
{
	my $thisparser = $_[0];
	use vars q{$tracelevel};
	local $tracelevel = ($tracelevel||0)+1;
...
# ARGS ARE: ($parser, $text; $repeating, $_noactions, \@args, $_itempos)
sub Parse::RecDescent::_Runtime::BVA::KALE::DATA::WHERE::Parser::item
{
	my $thisparser = $_[0];
	use vars q{$tracelevel};
	local $tracelevel = ($tracelevel||0)+1;
    ...
    while (!$_matched && !$commit)
    {
        ...
        unless (defined ($_tok = Parse::RecDescent::_Runtime::BVA::KALE::DATA::WHERE::Parser::list($thisparser,$text,$repeating,$_noactions,sub { \@arg },undef)))
        {
    ...
    while (!$_matched && !$commit)
    {
        ...
        if (1) { no strict qw{refs};
        $expectation->is(q{})->at($text);
        unless (defined ($_tok = Parse::RecDescent::_Runtime::BVA::KALE::DATA::WHERE::Parser::word($thisparser,$text,$repeating,$_noactions,sub { \@arg },undef)))
        {
...
# ARGS ARE: ($parser, $text; $repeating, $_noactions, \@args, $_itempos)
sub Parse::RecDescent::_Runtime::BVA::KALE::DATA::WHERE::Parser::list
{
	my $thisparser = $_[0];
	use vars q{$tracelevel};
	local $tracelevel = ($tracelevel||0)+1;
    ...
    while (!$_matched && !$commit)
    {
        ...
        unless (defined ($_tok = Parse::RecDescent::_Runtime::BVA::KALE::DATA::WHERE::Parser::item($thisparser,$text,$repeating,$_noactions,sub { \@arg },undef)))
        {
