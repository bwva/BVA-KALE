...
use lib '/Library/WebServer/CGI-Executables/BVA/KALE';
use lib '/Library/WebServer/CGI-Executables/BVA/KALE/DATA';
use lib '/Library/WebServer/CGI-Executables/BVA/KALE/DATA/WHERE';
...
#             $grammar, "BVA::KALE::DATA::WHERE::Parser")
