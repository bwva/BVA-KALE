package BVA::KALE::DATETIME;

$BVA::KALE::DATETIME::VERSION	= '1.020.020';   # 2012-12-21
...
sub list_months {
	...
	wantarray ? @BVA::KALE::DATETIME::MONTHS : [ @BVA::KALE::DATETIME::MONTHS ]
}
...
sub list_abbr_months {
	...
	wantarray ? @BVA::KALE::DATETIME::ABBR_MONTHS : [ @BVA::KALE::DATETIME::ABBR_MONTHS ]
}
...
sub list_weekdays {
	...
	wantarray ? @BVA::KALE::DATETIME::WEEKDAYS : [ @BVA::KALE::DATETIME::WEEKDAYS ]
}
...
sub list_abbr_weekdays {
	...
	wantarray ? @BVA::KALE::DATETIME::ABBR_WEEKDAYS : [ @BVA::KALE::DATETIME::ABBR_WEEKDAYS ]
}
...
sub list_initial_weekdays {
	...
	wantarray ? @BVA::KALE::DATETIME::INITIAL_WEEKDAYS : [ @BVA::KALE::DATETIME::INITIAL_WEEKDAYS ]
}
...
sub list_monthday_nums {
	...
	wantarray ? @BVA::KALE::DATETIME::MONTHDAY_NUMS : [ @BVA::KALE::DATETIME::MONTHDAY_NUMS ]
}
...
sub this_cc {
	...
	$BVA::KALE::DATETIME::THIS_CC
}

sub month_num_lookup {
	@BVA::KALE::DATETIME::MONTH_NUM_TBL{@_};
}
...
BEGIN {
	...
	@BVA::KALE::DATETIME::INITIAL_WEEKDAYS	= qw/
		S
		M
		T
		W
